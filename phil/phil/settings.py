...
PAYSTACK_SETTINGS = {
    ...
    'BUTTON_ID': 'paystack-payment-button',  # Default button ID (customize if needed)
    'CURRENCY': 'NGN',
    'BUTTON_CLASS': 'btn btn-primary',  # Add this line if missing
...
CSRF_TRUSTED_ORIGINS = [
    'https://yourdomain.com',
    'https://*.yourdomain.com',  # Supports subdomains
